...
namespace Horseshoe.NET.Caching
{
    ...
    public interface IAppCache
    {
        ...
        /// <returns></returns>
        E GetFromCache<E>(object key, Func<E> refreshFunction, out bool fromCache, int? cacheDuration = null, bool forceRefresh = false);
        ...
        /// <param name="forceRefresh"></param>
        /// <returns></returns>
        E GetFromCache<E>(object key, Func<E> refreshFunction, ICacheMetadata metadata = null, int? cacheDuration = null, bool forceRefresh = false);
        ...
        /// <param name="forceRefresh"></param>
        /// <returns></returns>
        Task<E> GetFromCacheAsync<E>(object key, Func<Task<E>> refreshFunction, ICacheMetadata metadata = null, int? cacheDuration = null, bool forceRefresh = false);
        ...
        /// <param name="forceRefresh"></param>
        /// <returns></returns>
        IList<E> GetListFromCache<E>(object key, Func<IList<E>> refreshFunction, out bool fromCache, int? cacheDuration = null, bool forceRefresh = false);
        ...
        /// <param name="forceRefresh"></param>
        /// <returns></returns>
        IList<E> GetListFromCache<E>(object key, Func<IList<E>> refreshFunction, ICacheMetadata metadata = null, int? cacheDuration = null, bool forceRefresh = false);
        ...
        /// <param name="forceRefresh"></param>
        /// <returns></returns>
        Task<IList<E>> GetListFromCacheAsync<E>(object key, Func<Task<IList<E>>> refreshFunction, ICacheMetadata metadata = null, int? cacheDuration = null, bool forceRefresh = false);
    }
}
