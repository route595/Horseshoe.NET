...
namespace Horseshoe.NET.Odbc
{
    ...
    public static class Delete
    {
        ...
        )
        {
            ...
            var rowsDeleted = Execute.SQL(conn, statement, transaction: transaction, commandTimeout: commandTimeout, peekCommand: peekCommand);

            SystemMessageRelay.RelayMethodReturn(returnDescription: "rows deleted: " + rowsDeleted, group: MessageRelayGroup);
            return rowsDeleted;
        }
    }
}
