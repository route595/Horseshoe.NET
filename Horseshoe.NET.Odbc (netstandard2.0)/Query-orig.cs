...
//                using (var command = OdbcUtil.BuildTextCommand(conn, statement, null, transaction, commandTimeout, peekCommand))
//                {
...
//                var conn = OdbcUtil.LaunchConnection(connectionInfo, peekConnection: peekConnection, journal: journal);
...
//                var command = OdbcUtil.BuildTextCommand(conn, statement, null, transaction, commandTimeout, peekCommand);
//                var result = keepOpen
...
//                using (var conn = OdbcUtil.LaunchConnection(connectionInfo, peekConnection: peekConnection, journal: journal))
//                {
//                    var result = AsObjects(conn, tableName, dbCapture: dbCapture, columns: columns, where: wher\e, groupBy: groupBy, orderBy: orderBy, autoTrunc: autoTrunc, commandTimeout: commandTimeout, peekCommand: peekCommand, journal: journal);
...
//                using (var command = OdbcUtil.BuildTextCommand(conn, statement, null, null, commandTimeout, peekCommand))
//                {
//                    var result = command.ExecuteScalar();
//                    journal.Level--;  // finalize
//                    result = DbUtil.ProcessScalarResult(result, autoTrunc: autoTrunc);
...
//                var command = OdbcUtil.BuildTextCommand(conn, statement, null, null, commandTimeout, peekCommand);
//                var result = keepOpen
//                    ? command.ExecuteReader(CommandBehavior.Default)
//                    : command.ExecuteReader(CommandBehavior.CloseConnection);
...
//                using (var command = OdbcUtil.BuildProcedureCommand(conn, procedureName, parameters, transaction, commandTimeout, peekCommand))
//                {
//                    var result = command.ExecuteScalar();
//                    journal.Level--;  // finalize
//                    result = DbUtil.ProcessScalarResult(result, autoTrunc: autoTrunc);
...
//                var command = OdbcUtil.BuildProcedureCommand(conn, procedureName, parameters, transaction, commandTimeout, peekCommand);
//                var result = keepOpen
//                    ? command.ExecuteReader(CommandBehavior.Default)
//                    : command.ExecuteReader(CommandBehavior.CloseConnection);
...
//                var statement = DbUtil.BuildFunctionStatement(provider, functionName, parameters: parameters, journal: journal);
//                using (var command = OdbcUtil.BuildTextCommand(conn, statement, null, null, commandTimeout, peekCommand))  // not including parameters here due to already embedded in the SQL statement
//                {
//                    var result = command.ExecuteScalar();
//                    journal.Level--;  // finalize
//                    result = DbUtil.ProcessScalarResult(result, autoTrunc: autoTrunc);
...
//                var statement = DbUtil.BuildFunctionStatement(provider, functionName, parameters: parameters, journal: journal);
//                var command = OdbcUtil.BuildTextCommand(conn, statement, null, null, commandTimeout, peekCommand);  // not including parameters here due to already embedded in the SQL statement
//                var result = keepOpen
//                    ? command.ExecuteReader(CommandBehavior.Default)
//                    : command.ExecuteReader(CommandBehavior.CloseConnection);
...
//                if (fromStoredProc)
//                {
//                    using (var command = OdbcUtil.BuildProcedureCommand(conn, statement, parameters, transaction, commandTimeout, peekCommand))
//                    {
