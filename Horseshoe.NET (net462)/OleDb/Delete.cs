...
namespace Horseshoe.NET.OleDb
{
    ...
    public static class Delete
    {
        ...
        )
        {
            ...
            {
                var result = Table(conn, platform, tableName, where, drop: drop, purge: purge, commandTimeout: commandTimeout, alterCommand: alterCommand, journal: journal);
        ...
        )
        {
            ...
            // data stuff
            var statement = DbUtil.BuildDeleteStatement(platform, tableName, where, drop: drop, purge: purge, journal: journal);
