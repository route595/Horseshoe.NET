...
namespace Horseshoe.NET.OleDb
{
    ...
    public static class Insert
    {
        ...
        )
        {
            ...
            using (var conn = OleDbUtil.LaunchConnection(connectionInfo, peekConnection: peekConnection))
            {
                var rowsInserted = Table(out identity, conn, tableName, columnNamesAndValues, altGetIdentitySql: altGetIdentitySql, provider: provider, commandTimeout: commandTimeout, peekCommand: peekCommand);
