...
namespace Horseshoe.NET.OleDb
{
    public static class Query
    {
        public static class SQL
        {
            ...
            {
                using (var cmd = OleDbUtil.BuildCommand(conn, CommandType.Text, statement, timeout: timeout, modifyCommand: modifyCommand))
                {
            ...
            public static OleDbDataReader AsDataReader
            (
                string statement,
                OleDbConnectionInfo connectionInfo = null,
                bool keepOpen = false,
            ...
            public static async Task<OleDbDataReader> AsDataReaderAsync
            (
                string statement,
                OleDbConnectionInfo connectionInfo = null,
                bool keepOpen = false,
            ...
            {
                var cmd = OleDbUtil.BuildCommand(conn, CommandType.Text, statement, timeout: timeout, modifyCommand: modifyCommand);
                var reader = keepOpen
        ...
        public static class TableOrView
        {
            ...
            {
                var conn = OleDbUtil.LaunchConnection(connectionInfo, cryptoOptions: cryptoOptions, resultantConnectionInfo: resultantConnectionInfo);
        ...
        public static class Procedure
        {
            ...
            {
                var cmd = OleDbUtil.BuildCommand(conn, CommandType.StoredProcedure, procedureName, parameters: parameters, timeout: timeout, modifyCommand: modifyCommand);
                var reader = keepOpen
                    ? cmd.ExecuteReader(CommandBehavior.Default)
                    : cmd.ExecuteReader(CommandBehavior.CloseConnection);
                if (dbCapture != null)
            ...
            )
            {
                ...
                using (var cmd = OleDbUtil.BuildCommand(conn, CommandType.StoredProcedure, procedureName, parameters: parameters, timeout: timeout, modifyCommand: modifyCommand))
                {
                    if (dbCapture != null)
                    {
                        dbCapture.OutputParameters = cmd.Parameters
        ...
        public static class TableFunction
        {
            ...
            )
            {
                ...
                using (var cmd = OleDbUtil.BuildCommand(conn, CommandType.Text, statement, timeout: timeout, modifyCommand: modifyCommand))  // not including parameters here due to already embedded in the SQL statement
                {
                    var obj = cmd.ExecuteScalar();
                    if (ObjectUtil.IsNull(obj))
                        return null;
            ...
            )
            {
                ...
                var cmd = OleDbUtil.BuildCommand(conn, CommandType.Text, statement, timeout: timeout, modifyCommand: modifyCommand);  // not including parameters here due to already embedded in the SQL statement
                var reader = keepOpen
                    ? cmd.ExecuteReader(CommandBehavior.Default)
                    : cmd.ExecuteReader(CommandBehavior.CloseConnection);
                return reader;
        ...
        (
            ...
            int? timeout,
            Action<OleDbCommand> modifyCommand
        )
        {
            var list = new List<T>();
            ...
            if (objectParser != null)
            {
                ...
                if (fromStoredProc)
                {
                    using (var cmd = OleDbUtil.BuildCommand(conn, CommandType.StoredProcedure, statement, parameters: parameters, timeout: timeout, modifyCommand: modifyCommand))
                    {
