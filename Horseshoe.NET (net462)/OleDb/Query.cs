...
namespace Horseshoe.NET.OleDb
{
    ...
    /// </summary>
    public class Query : QueryBase<OleDbConnectionInfo, OleDbConnection, OleDbCommand, OleDbDataAdapter, OleDbTransaction>
    {
        ...
        public Query
        (
            OleDbConnectionInfo connectionInfo,
            string statement,
        ...
        /// <inheritdoc cref="OleDbUtil.BuildCommand(OleDbConnection, string, CommandType, IEnumerable{DbParameter}, OleDbTransaction, int?, Action{OleDbCommand})"/>
        public override OleDbCommand BuildCommand(OleDbConnection conn) =>
            OleDbUtil.BuildCommand(conn, Statement, CommandType, Parameters, Transaction, CommandTimeout, PeekCommand);

        /// <inheritdoc cref="OleDbUtil.LaunchConnection(OleDbConnectionInfo, Action{OleDbConnection}, CryptoOptions)"/>
        public override OleDbConnection LaunchConnection() =>
            OleDbUtil.LaunchConnection(connectionInfo: ConnectionInfo, peekConnection: PeekConnection, cryptoOptions: CryptoOptions);
        ...
        public override OleDbDataAdapter BuildDataAdapter(OleDbCommand cmd) =>
