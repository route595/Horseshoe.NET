...
{
    /// <summary>
    /// Provides user impersonation in .NET Framework applications
    /// </summary>
    public static class Auth
    {
        ...
        /// <summary>
        /// Impersonates a user within a .NET Framework process
        /// </summary>
        /// <param name="userName">A user name</param>
        /// <param name="password">A password</param>
        /// <param name="domain">A Windows domain</param>
        /// <param name="useBatchLogon">Set to <c>true</c> if the current process is a batch job, default is <c>false</c>.</param>
