...
namespace Horseshoe.NET.DataImport
{
    ...
    public static class Extensions
    {
        ...
        public static DataImport ImportDelimitedText(this DataImport dataImport, params IColumn[] columns)
        {
            // validation
        ...
        /// <exception cref="SecurityException"></exception>
        /// <exception cref="ValidationException"></exception>
        public static DataImport ImportFixedWidthText(this DataImport dataImport, params IColumn[] columns)
        {
            // validation
        ...
        /// <returns>This <c>DataImport</c> instance.</returns>
        public static DataImport Render(this DataImport dataImport, AutoTruncate autoTrunc = AutoTruncate.Trim)
        {
            // prep
            dataImport.Clear();
        ...
        /// <param name="dataImport"></param>
        /// <returns></returns>
        public static List<string[]> ExportToStrings(this DataImport dataImport)
        {
