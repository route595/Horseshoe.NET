...
namespace Horseshoe.NET
{
    ...
    public static class Zap
    {
        ...
        public static bool Boolean(object obj, bool defaultValue = false, string trueValues = "y|yes|t|true|1", string falseValues = "n|no|f|false|0", bool ignoreCase = false, bool treatArbitraryAsFalse = false)
        {
            return NBoolean(obj, trueValues: trueValues, falseValues: falseValues, ignoreCase: ignoreCase, treatArbitraryAsFalse: treatArbitraryAsFalse) ?? defaultValue;
        }
        ...
        /// <returns><c>true</c> or <c>false</c></returns>
        /// <exception cref="ConversionException"></exception>
        public static bool? NBoolean(object obj, string trueValues = "y|yes|t|true|1", string falseValues = "n|no|f|false|0", bool ignoreCase = false, bool treatArbitraryAsFalse = false)
        {
            ...
            if (obj is string stringValue)
            {
                if (ignoreCase ? stringValue.InIgnoreCase(trueValues.Split('|')) : stringValue.In(trueValues.Split('|')))
                    return true;
                if (treatArbitraryAsFalse || (ignoreCase ? stringValue.InIgnoreCase(falseValues.Split('|')) : stringValue.In(falseValues.Split('|'))))
                    return false;
        ...
        public static Type Type(object obj, Type inheritedType = null, bool ignoreCase = false)
        {
            ...
            var type = obj is Type _type
                ? _type
                : (obj is string typeName ? TypeUtil.GetType(typeName, ignoreCase: ignoreCase) : throw new ConversionException("Cannot convert \"" + obj + "\" to type."));
        ...
        )
        {
            ...
            if (type == typeof(bool)) return Boolean(obj, trueValues: trueValues, falseValues: falseValues, ignoreCase: ignoreCase);
