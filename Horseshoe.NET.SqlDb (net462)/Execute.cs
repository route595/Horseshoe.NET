...
namespace Horseshoe.NET.SqlDb
{
    ...
    public static class Execute
    {
        ...
        )
        {
            ...
            // data stuff
            using (var cmd = SqlDbUtil.BuildProcedureCommand(conn, procedureName, parameters, commandTimeout, alterCommand))
            {
        ...
        )
        {
            ...
            // data stuff
            using (var cmd = SqlDbUtil.BuildTextCommand(conn, statement, parameters, commandTimeout, alterCommand))   // parameters optional here, e.g. may already be included in the SQL statement
            {
                var result = cmd.ExecuteNonQuery();
