...
#pragma warning restore IDE1006 // Naming Styles
            public AccessTokenBody ToTokenBody()
            {
                return new AccessTokenBody
                {
                    ...
                    NotBeforeDateUTC = new DateTime(1970, 1, 1, 0, 0, 0, DateTimeKind.Utc).AddSeconds(nbf),
                    ExpirationDateUTC = new DateTime(1970, 1, 1, 0, 0, 0, DateTimeKind.Utc).AddSeconds(exp),
                    IssueDateUTC = new DateTime(1970, 1, 1, 0, 0, 0, DateTimeKind.Utc).AddSeconds(iat),
                    AppType = apptype,
                    AppID = appid,
