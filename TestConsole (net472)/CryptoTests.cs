        ...
        public override IList<MenuObject> Menu => new[]
        {
            ...
            (
                ...
                () =>
                {
                    for (int i = 0; i < 3; i++)
                    {
                        var algorithm = new RijndaelManaged { Key = ArrayUtil.Pad(null, 32, padWith: (byte)32) };
                        var ciphertext = Encrypt.String("This is your life!", new CryptoOptions { Algorithm = algorithm });
                        Console.WriteLine("This is your life!" + " -> " + TextUtil.Crop(ciphertext, 26, truncateMarker: TruncateMarker.LongEllipsis) + " -- Key: " + TextUtil.Crop(string.Join(", ", algorithm.Key), 26, truncateMarker: TruncateMarker.LongEllipsis) + " -- IV: " + TextUtil.Crop(string.Join(", ", algorithm.IV), 26, truncateMarker: TruncateMarker.LongEllipsis));
                    }
                }
            ...
            (
                ...
                () =>
                {
                    for (int i = 0; i < 3; i++)
                    {
                        var algorithm = new RijndaelManaged { Key = ArrayUtil.Pad(null, 32, padWith: (byte)32), IV = ArrayUtil.Pad(null, 16, padWith: (byte)16) };
                        var ciphertext = Encrypt.String("This is your life!", new CryptoOptions { Algorithm = algorithm });
                        Console.WriteLine("This is your life! -> " + TextUtil.Crop(ciphertext, 26, truncateMarker: TruncateMarker.LongEllipsis) + " -- Key: " + TextUtil.Crop(string.Join(", ", algorithm.Key), 26, truncateMarker: TruncateMarker.LongEllipsis) + " -- IV: " + TextUtil.Crop(string.Join(", ", algorithm.IV), 26, truncateMarker: TruncateMarker.LongEllipsis));
                    }
                }
            ...
            (
                ...
                () =>
                {
                    ...
                    var hash2 = Hash.String(input2, new HashOptions { Algorithm = new SHA256CryptoServiceProvider(), Salt = 112 });
            ...
            (
                ...
                () =>
                {
                    CryptoSettings.DefaultHashAlgorithm = new SHA256CryptoServiceProvider();
            ...
            (
                ...
                () =>
                {
                    ...
                    var fileHash = Hash.String(fileToHashPath, new HashOptions { Algorithm = new MD5CryptoServiceProvider() });
